...
const styles = StyleSheet.create({
  wrap: { backgroundColor: colors.card, borderColor: '#E8B95E', borderWidth: 1, borderRadius: 10, paddingVertical: 16, paddingLeft: 16, paddingRight: 92, marginTop: 18, minHeight: 86, justifyContent: 'center', overflow: 'hidden' },
